...
public class PostsDbHelper extends SQLiteOpenHelper {
    ...
    private static final String SQL_CREATE_ENTRIES =
            "CREATE TABLE " + Posts.PostEntry.TABLE_NAME + " (" +
                    ...
                    Posts.PostEntry.COLUMN_NAME_IMAGE_URI + TEXT_TYPE + COMMA_SEP +
                    Posts.PostEntry.COLUMN_NAME_IMAGE_URI2 + TEXT_TYPE + COMMA_SEP +
                    Posts.PostEntry.COLUMN_NAME_IMAGE_URI3 + TEXT_TYPE + COMMA_SEP +
                    Posts.PostEntry.COLUMN_NAME_LAT + TEXT_TYPE + COMMA_SEP +
                    Posts.PostEntry.COLUMN_NAME_LONG + TEXT_TYPE +
            " )";
